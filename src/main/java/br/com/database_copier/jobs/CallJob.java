...
public class CallJob {
	...
	public static void execute(final Integer itensPerPage, final Integer poolLimit, final Session source) {
		...
		final String sourceTable = "call";
		final String targetTable = "call";

		final String[] fields = { "id", "active", "call_status", "created_at", "created_by", "ended_at", "started_at",
