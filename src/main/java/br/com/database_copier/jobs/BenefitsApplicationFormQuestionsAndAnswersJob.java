...
public class BenefitsApplicationFormQuestionsAndAnswersJob {
	...
	public static void execute(Integer itensPerPage) {
		...
		final String sourceTable = "benefits_application_form_questions_and_answers";
		final String targetTable = "benefitsApplicationFormQuestionsAndAnswers";
		...
		while (hasMoreElements) {
			...
			final AbstractConverter<BenefitsApplicationFormQuestionsAndAnswers> converter = new AbstractConverter<BenefitsApplicationFormQuestionsAndAnswers>()
					.convertjsonToEntityList(BenefitsApplicationFormQuestionsAndAnswers.class,
							GenericUtils.objectsToJson(list, fields));

			List<BenefitsApplicationFormQuestionsAndAnswers> entityList = converter.getEntities();
			...
			for (i = 0; i < entityList.size(); i++) {
				...
				final BenefitsApplicationFormQuestionsAndAnswers entity = entityList.get(i);

				if (entity.getBenefitsApplicationFormId() != null) {
					entity.setBenefitsApplicationForm(new BenefitsApplicationForm());
					entity.getBenefitsApplicationForm().setId(entity.getBenefitsApplicationFormId());
				}
