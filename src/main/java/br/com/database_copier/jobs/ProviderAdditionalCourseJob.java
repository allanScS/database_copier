...
public class ProviderAdditionalCourseJob {
	...
	public static void execute(Integer itensPerPage) {
		...
		final String sourceTable = "provider_additional_course";
		final String targetTable = "providerAdditionalCourse";

		final String[] fields = { "id", "created_at", "created_by", "deleted", "deleted_at", "deleted_by", "updated_at",
				"updated_by", "certificate_number", "description", "favourite", "provider_id" };
		...
		while (hasMoreElements) {
			...
			final AbstractConverter<ProviderAdditionalCourse> converter = new AbstractConverter<ProviderAdditionalCourse>()
					.convertjsonToEntityList(ProviderAdditionalCourse.class, GenericUtils.objectsToJson(list, fields));

			final List<ProviderAdditionalCourse> entityList = converter.getEntities();
			...
			for (i = 0; i < entityList.size(); i++) {
				...
				final ProviderAdditionalCourse entity = entityList.get(i);
