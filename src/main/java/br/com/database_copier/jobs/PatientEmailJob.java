...
public class PatientEmailJob {
	...
	public static void execute(Integer itensPerPage) {
		...
		while (hasMoreElements) {
			...
			final AbstractConverter<PatientEmail> converter = new AbstractConverter<PatientEmail>()
					.convertjsonToEntityList(PatientEmail.class, GenericUtils.objectsToJson(list, fields));

			final List<PatientEmail> entityList = converter.getEntities();
			...
			for (i = 0; i < entityList.size(); i++) {
				...
				final PatientEmail entity = entityList.get(i);
