...
public class CompanyAdditionalBenefitJob {
	...
	public static void execute(Integer itensPerPage) {
		...
		final String sourceTable = "company_additional_benefit";
		final String targetTable = "companyAdditionalBenefit";

		final String[] fields = { "id", "created_at", "created_by", "deleted", "deleted_at", "deleted_by", "updated_at",
				"updated_by", "description", "seq", "company_id" };
		...
		while (hasMoreElements) {
			...
			final AbstractConverter<CompanyAdditionalBenefit> converter = new AbstractConverter<CompanyAdditionalBenefit>()
					.convertjsonToEntityList(CompanyAdditionalBenefit.class, GenericUtils.objectsToJson(list, fields));

			List<CompanyAdditionalBenefit> entityList = converter.getEntities();
			...
			for (i = 0; i < entityList.size(); i++) {
				...
				final CompanyAdditionalBenefit entity = entityList.get(i);
