...
public class CompanyManagerEmailJob {
	...
	public static void execute(Integer itensPerPage) {
		...
		final String sourceTable = "company_manager_email";
		final String targetTable = "companyManagerEmail";
		...
		while (hasMoreElements) {
			...
			final AbstractConverter<CompanyManagerEmail> converter = new AbstractConverter<CompanyManagerEmail>()
					.convertjsonToEntityList(CompanyManagerEmail.class, GenericUtils.objectsToJson(list, fields));

			final List<CompanyManagerEmail> entityList = converter.getEntities();
			...
			for (i = 0; i < entityList.size(); i++) {
				...
				final CompanyManagerEmail entity = entityList.get(i);
