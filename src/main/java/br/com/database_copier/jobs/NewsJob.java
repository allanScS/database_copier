...
public class NewsJob {
	...
	public static void execute(final Integer itensPerPage, final Integer poolLimit, final Session source) {
		...
		final String sourceTable = "news";
		final String targetTable = "news";

		final String[] fields = { "id", "active", "created_at", "created_by", "deleted", "deleted_at", "deleted_by",
				"description_in_html", "expiration_date", "postage_date", "status", "thumbnail", "title", "updated_at",
				"updated_by", "viewers", "content_image_url", "video_url", "ordination" };
